...
df = pd.read_csv('datafortrader/test.csv', parse_dates=['Date'])
...
# print(array_lower)
data['array_lower'] =pd.DataFrame(array_lower)
print(data.head())
...
data['array_middle'] =pd.DataFrame(array_middle)
print(data.head())
# # Plotting the graph
